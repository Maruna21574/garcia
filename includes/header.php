...
$cmsSite = cms_data()['site'];
$cmsPhoneHref = preg_replace('/\s+/', '', (string) $cmsSite['phone']);
$navigation = cms_data()['navigation'];
...
$cmsSocialImage = (string) ($cmsSite['social_image'] ?? 'assets/images/brand/og-garcia-chata.png');
$socialImage = $socialImage ?? (preg_match('/^https?:\/\//i', $cmsSocialImage) ? $cmsSocialImage : rtrim($publicOrigin, '/') . '/' . ltrim($cmsSocialImage, '/'));
...
$schemaPhone = preg_replace('/\D+/', '', (string) $cmsSite['phone']);
$schemaPhone = $schemaPhone !== '' && strpos($schemaPhone, '0') === 0 ? '+421' . substr($schemaPhone, 1) : ($schemaPhone !== '' ? '+' . $schemaPhone : '');
$businessSchema = [
    '@context' => 'https://schema.org',
    '@type' => 'LocalBusiness',
    'name' => (string) $cmsSite['name'] . ' — ' . (string) $cmsSite['tagline'],
    'description' => $metaDescription,
    'url' => $canonicalUrl,
    'image' => $socialImage,
    'areaServed' => (string) $cmsSite['location'],
    'email' => (string) $cmsSite['email'],
    'telephone' => $schemaPhone,
    'sameAs' => [(string) $cmsSite['facebook']],
];
?>
<!doctype html>
<html lang="sk">
<head>
    ...
    <meta property="og:site_name" content="<?= e($cmsSite['name']) ?>">
    ...
    <link rel="icon" type="image/svg+xml" href="<?= e($cmsSite['favicon']) ?>">
    <link rel="apple-touch-icon" href="<?= e($cmsSite['favicon']) ?>">
        ...
        <div class="topbar">
            <div class="container topbar__inner">
                <div class="topbar__contact">
                    <a class="topbar__contact-link" href="tel:<?= e($cmsPhoneHref) ?>">
                        ...
                        <span><?= e($cmsSite['phone']) ?></span>
                    </a>
                    <a class="topbar__contact-link" href="mailto:<?= e($cmsSite['email']) ?>">
                        <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3.5 6.5h17v11h-17z M4 7l8 6 8-6"/></svg>
                        <span><?= e($cmsSite['email']) ?></span>
                    </a>
                </div>
                <div class="topbar__right"><span><?= e($cmsSite['location']) ?></span><a class="topbar__social" href="<?= e($cmsSite['facebook']) ?>" target="_blank" rel="noopener noreferrer" aria-label="GARCIA na Facebooku"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M14 8h3V4.4c-.5-.1-1.7-.2-3.2-.2-3.2 0-5.4 2-5.4 5.5V13H5v4h3.4v7h4.2v-7h3.5l.6-4h-4.1V10c0-1.2.3-2 1.4-2Z"/></svg></a></div>
            </div>
        </div>
        <div class="container header__inner">
            <a href="index.php" class="logo" aria-label="GARCIA — domov">
                <img src="<?= e($cmsSite['logo']) ?>" alt="<?= e($cmsSite['name'] . ' — ' . $cmsSite['tagline']) ?>" class="logo__img">
            </a>
            <nav class="main-nav" id="main-nav" data-nav aria-label="Hlavná navigácia">
                <div class="mobile-nav__head">
                    <a href="index.php" class="mobile-nav__logo" aria-label="GARCIA — domov">
                        <img src="<?= e($cmsSite['logo']) ?>" alt="<?= e($cmsSite['name']) ?>" class="mobile-nav__logo-img">
                    </a>
            ...
            <div class="header__actions">
                <a href="kontakt.php" class="btn btn--gold header__cta"><?= e($cmsSite['header_cta']) ?></a>
